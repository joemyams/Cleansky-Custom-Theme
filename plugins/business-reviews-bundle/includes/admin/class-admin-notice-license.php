    ...
    public function license() {
        ...
        if (!$brb_license_status || !$license_is_active) {
            ...
            $notice = '<p style="font-weight:600;font-size:15px;">' .
                      ...
                      '</p>' .
                      '<p style="font-weight:normal;font-size:15px;">' .
                          'To activate your business license go to <a href="https://admin.richplugins.com/licenses" target="_blank">the admin panel</a> (Licenses tab), copy your license code and save on <a href="' . admin_url('admin.php?page=brb-settings&brb_tab=license') . '" target="_blank">the settings page</a>.' .
                      '</p>' .
                      '<p>' .
