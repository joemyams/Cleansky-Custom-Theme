...
var AUTOSAVE_TIMEOUT = null,
    ...
    '<div class="rplg-connect-options">' +
        ...
        '<div class="rplg-builder-inside" style="display:none">' +
            ...
            '<div class="rplg-builder-option">' +
                'Slides height' +
                '<input type="text" name="slider_review_height" value="" placeholder="by default: 100px">' +
            '</div>' +
            '<div class="rplg-builder-option">' +
            ...
            '<div class="rplg-builder-option">' +
                '<label>' +
                    ...
                    '<div class="rplg-well" onclick="if(event.target.type != \'file\')return false">' +
                        ...
                        '</div>' +
                        '<div class="rplg-builder-option">' +
                            'Show \'Write a review\' button for:' +
                            '<select id="summary_wr" name="summary_wr"></select>' +
                        '</div>' +
                    '</div>' +
                '</label>' +
                '<span class="rplg-quest rplg-quest-top rplg-toggle" title="Click to help">?</span>' +
        ...
        '<div class="rplg-builder-inside" style="display:none">' +
            ...
            '<div class="rplg-builder-option">' +
                'GMB API limit' +
                '<input type="text" name="google_api_limit" value="" placeholder="By default: 25">' +
            '</div>' +
            '<div class="rplg-builder-option">' +
            ...
            '</div>' +
            '<div class="rplg-builder-option">' +
                'Hide on the pages (URL paths by commas)' +
                ...
                success  : function (res) {
                    ...
                    $.ajax({
                        ...
                        success  : function (res) {
                            ...
                            var autosave = (res.data.length == 1);
...
function rplg_view_mode_listener() {
...
function rplg_theme_options_hide() {
    for (let i = 0; i < view_mode.options.length; i++) {
        let theme_el = document.querySelector('.' + view_mode.options[i].value);
        if (theme_el) {
    ...
    let visible_el = document.querySelector('.' + view_mode.value);
    if (visible_el) {
...
function rplg_connection_add($, conn, checked) {
    ...
    var connected_id = rplg_connection_id(conn);

    var connected_el = el.querySelector('#' + connected_id);
    if (connected_el) return;
